...
> **Note**: For DevOps platform integration (Azure DevOps, CI/CD pipelines), see [DevOps](../../concepts/devops.md). For Git command syntax, see [Git Command Reference](git.md).

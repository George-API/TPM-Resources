...
1. **Brainstorm stakeholders**: project team, subject matter experts, organizational charts
2. **Review governance structures**: steering committees, oversight bodies, approval authorities
3. **Map organizational relationships**: reporting lines, dependencies, partnerships
4. **Identify external stakeholders**: citizens, media, advocacy groups, vendors
5. **Document in stakeholder register**: roles, interests, influence, expectations

### Stakeholder Register Elements

- **Name/Organization**: Stakeholder name and organizational affiliation
- **Role**: Official role, title, position
- **Interest**: What they care about, what they need from project
- **Influence**: Power to impact project (high, medium, low)
- **Impact**: How project affects them (high, medium, low)
...
- **Keep satisfied** (High Power, Low Interest): Monitor, keep informed, don't over-communicate
- **Keep informed** (Low Power, High Interest): Regular updates, involve in feedback
- **Monitor** (Low Power, Low Interest): Minimal effort, periodic updates

### Influence/Impact Matrix

- **High Influence, High Impact**: Critical stakeholders, manage closely
- **High Influence, Low Impact**: Keep satisfied, may become blockers if ignored
...
- **Unaware**: Don't know about project; need awareness
- **Resistant**: Opposed to project; need to address concerns, build support
- **Neutral**: No strong opinion; need to demonstrate value, build interest
- **Supportive**: Support project; need to maintain support, leverage as champions
- **Leading**: Actively championing project; need to empower, leverage influence

### Engagement Strategies by Level

- **Unaware → Aware**: Communication campaigns, announcements, briefings
- **Resistant → Neutral/Supportive**: Address concerns, demonstrate value, build trust
...
- **Public meetings**: Town halls, public forums, board meetings
- **Public websites**: Project portals, status dashboards, public information
- **Email updates**: Regular newsletters, status updates, announcements
- **Press releases**: Media communications, public announcements
- **Social media**: Public engagement, updates, community interaction
...
- **Start early**: Identify and engage stakeholders from project initiation
- **Build relationships**: Invest in relationship building, not just transactional communication
- **Understand motivations**: Understand what stakeholders care about, what drives them
- **Manage expectations**: Set realistic expectations, communicate trade-offs clearly
...
- **Right stakeholder, right time**: Engage stakeholders when their input is needed
- **Appropriate level of engagement**: Match engagement level to stakeholder needs
- **Two-way communication**: Listen as much as communicate; gather feedback
- **Follow through**: Deliver on commitments, address concerns, close feedback loops
- **Celebrate wins**: Share successes, recognize contributions, build momentum

### Communication Best Practices

- **Clear, concise messaging**: Avoid jargon, use plain language, be specific
- **Visual communication**: Use visuals, dashboards, infographics for clarity
- **Multiple channels**: Use various channels to reach different stakeholders
- **Consistent messaging**: Aligned messaging across all channels, stakeholders
- **Regular cadence**: Predictable communication schedule, not just when issues arise

### Conflict Resolution

- **Address early**: Don't let conflicts escalate; address proactively
- **Understand perspectives**: Listen to all sides, understand concerns
- **Find common ground**: Identify shared interests, mutual benefits
- **Escalate appropriately**: Know when to escalate, use proper channels
- **Document resolutions**: Document agreements, decisions, action items

---

> **Note**: For general PM fundamentals, see [Project Management](project_management.md). For IT-specific patterns, see [IT Project Management](itpm.md). For methodology frameworks, see [Project Management Methodologies](methodologies.md).

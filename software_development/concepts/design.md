...
> **Note**: For system-level architectural patterns, see [Software Architecture](architecture.md). For cloud-specific implementations, see [Cloud Architecture](../../data_management/concepts/platform/architecture.md).

...
**Purpose**: Use this for IT project management concerns. For general PM fundamentals, see [Project Management](project_management.md). For methodology frameworks, see [Project Management Methodologies](methodologies.md).
...
For full SDLC phases, methodologies, and practices, see [Software Development Life Cycle (SDLC)](sdlc.md).
...
> **Note**: For general PM fundamentals, see [Project Management](project_management.md). For methodology frameworks (Agile, Scrum, etc.), see [Project Management Methodologies](methodologies.md).
